...
def main():
    ...
    if a == 'data':
        ...
        sh1['I1'].value = 'distance'
        sh1['J1'].value = 'intersection?'
        sh1['K1'].value = 'dv, r = R_s'
        sh1['L1'].value = 'dv, r = R_c'
        sh1['M1'].value = 'R_sw (au), v_int = ' + str(v_int) + ', n = ' + str(n0) + ' years, R_c/R_sw = ' + str(k0)
